...
(function () {
  ...
  if (SK.linkOk(C.links.mint)) mint.href = C.links.mint; else if (C.mock) mint.href = '#'; else { mint.setAttribute('aria-disabled', 'true'); mint.removeAttribute('href'); mint.querySelector('.why').textContent = 'OpenSea link goes live at launch'; }
  ...
  async function refresh() {
    ...
    set('b-migrated', b.migrated == null ? SK.dash : `${SK.int(b.migrated)} / ${SK.int(migrateMax)}`);
    tick();
    return b;
  }
